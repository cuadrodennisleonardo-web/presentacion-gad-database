-- 014_create_user_rpc.sql
-- Server-side RPC function for creating users from the app.
-- This uses Supabase's internal admin functions (SECURITY DEFINER)
-- so the anon key in the browser can safely call it — only superadmins are allowed.
